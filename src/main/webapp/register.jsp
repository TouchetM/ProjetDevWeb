                            ...
                            <form method="post" action="register" class="user">
                                ...
                                <h6 class="h6 alert-danger">
                                    <%
                                        ...
                                        Map<String,String> erreurs_register = (Map<String,String>)request.getAttribute("erreur_register");

                                        if(erreurs_register != null){
                                            String name = "name";
                                            String erreur = erreurs_register.get(name);
                                            if(erreur != null)
                                                out.print(erreur);
                                        }
                                    %>
                                ...
                                <h6 class="h6 alert-danger">
                                    <%
                                            if(erreurs_register != null){
                                                String email = "email";
                                                String erreur = erreurs_register.get(email);
                                                if(erreur != null)
                                                out.print(erreur);
                                            }
                                    %>
                                ...
                                <h6 class="h6 alert-danger">
                                    <%
                                        if(erreurs_register != null){
                                            ...
                                            String erreur = erreurs_register.get(password);
                                            if(erreur != null)
                                                out.print(erreur);
                                        }
                                    %>
